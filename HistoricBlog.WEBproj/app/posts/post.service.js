...
var PostService = (function () {
    ...
    PostService.prototype.getPostsFilteredPage = function () {
        ...
        var promise = this._http.get(this._postUrl, { search: params }).toPromise()
    ...
    PostService.prototype.getPostt = function (id) {
        var url = this._postUrl + "/" + id;
        return this._http.get(url).toPromise().then(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
